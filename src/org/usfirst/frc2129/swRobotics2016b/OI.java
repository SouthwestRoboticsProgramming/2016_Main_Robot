...
public class OI {
    ...
    public OI() {
        ...
        buttonShooterFire = new JoystickButton(rightJoystick, 2);
        buttonShooterFire.whenPressed(new CommandGroupFire());
        buttonShooterSpinUp = new JoystickButton(rightJoystick, 1);
        ...
        buttonShooterIntake = new JoystickButton(leftJoystick, 1);
