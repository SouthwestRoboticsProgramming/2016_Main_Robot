...
public class OI {
    ...
    public JoystickButton buttonDoPID;
    ...
    public OI() {
        ...
        buttonDoPID=new JoystickButton(joystickLeft, 9);
        buttonDoPID.whenPressed(new CommandGroupTilterPIDAlign());

        // SmartDashboard Buttons
        SmartDashboard.putData("CommandUltrasonic2SubsystemReport", new CommandUltrasonic2SubsystemReport());
