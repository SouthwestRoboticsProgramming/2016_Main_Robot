...
import org.usfirst.frc2129.swRobotics2016b.commands.shooterPusher;
import org.usfirst.frc2129.swRobotics2016b.commands.shooterWheels;
...
public class OI {
    ...
    public OI() {
        ...
        shooterFire.whileHeld(new shooterPusher());
        shooterOut = new JoystickButton(rightJoystick, 6);
        shooterOut.whileHeld(new shooterWheels());
        shooterIn = new JoystickButton(rightJoystick, 4);
        shooterIn.whileHeld(new shooterWheels());
        ...
        SmartDashboard.putData("shooterPusher", new shooterPusher());
