...
public class SubsystemUltrasonic extends Subsystem {
    ...
    private final static Ultrasonic ultrasonicSensor = RobotMap.subsystemUltrasonicUltrasonicSensor;
    private final static AnalogInput analogUltrasonic = RobotMap.subsystemUltrasonicAnalogUltrasonic;
    ...
    public static double getDigitalDistance() {
    	return ultrasonicSensor.getRangeMM();
    }
    
    public static double getAnalogDistance() {
