...
public class RobotMap {
    ...
    public static SpeedController subsystemTilterMotorTilter;
    ...
    public static void init() {
        ...
        subsystemUltrasonicUltrasonicSensor = new Ultrasonic(4, 5);
        LiveWindow.addSensor("SubsystemUltrasonic", "UltrasonicSensor", subsystemUltrasonicUltrasonicSensor);
        
        subsystemTilterMotorTilter = new Talon(7);
        LiveWindow.addActuator("SubsystemTilter", "MotorTilter", (Talon) subsystemTilterMotorTilter);
