...
public class RobotMap {
    ...
    public static SpeedController subsystemSpinnersLeftController;
    public static SpeedController subsystemSpinnersRightController;
    ...
    public static void init() {
        ...
        subsystemSpinnersLeftController = new Jaguar(1);
        LiveWindow.addActuator("SubsystemSpinners", "LeftController", (Jaguar) subsystemSpinnersLeftController);
        
        subsystemSpinnersRightController = new Jaguar(3);
        LiveWindow.addActuator("SubsystemSpinners", "RightController", (Jaguar) subsystemSpinnersRightController);
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        ((Jaguar)subsystemSpinnersRightController).enableDeadbandElimination(true);
        ((Jaguar)subsystemSpinnersLeftController).enableDeadbandElimination(true);
    }
}
